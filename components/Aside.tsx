...
export default function Aside() {
  return (
    <aside className="hidden md:flex flex-col gap-12 py-8 bg-gray-500 h-full w-[300px] border-r border-gray-400">
      <div className="pl-6">
      ...
      <div className="dark:text-gray-300 flex flex-col justify-between h-full">
        <div>
            ...
            {boards.map((board, index) => {
              return (
                <li
                  key={board.name}
                  className={[
                    "flex items-center py-4 gap-4 pl-6",
                    index == 0 ? "bg-primary text-white rounded-r-full" : "",
                  ].join(" ")}
                >
                  <svg
                    width="16"
