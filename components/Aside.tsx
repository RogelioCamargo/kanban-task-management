      ...
      <div className="text-gray-300 flex flex-col justify-between h-full">
        <div>
          ...
          <ul className="pr-6">
            ...
            <li className="flex items-center py-4 gap-4 pl-6 rounded-r-full cursor-pointer hover:dark:bg-white hover:bg-primary hover:bg-opacity-10 hover:text-primary">
